                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-4 text-lg md:text-xl opacity-80 leading-relaxed mb-8">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <a href="#features" className="inline-flex items-center justify-center gap-2 bg-primary text-white px-8 py-3.5 rounded-full font-semibold transition-all duration-300 hover:bg-primary/90 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(61,204,199,0.3)]">
                                    Explore Features
                                </a>
                                <a href="#how" className="inline-flex items-center justify-center gap-2 card opacity-80 px-6 py-3 rounded-full font-semibold backdrop-blur-sm transition duration-300 hover:bg-white/5">
                                    How It Works
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="relative flex justify-center lg:justify-end group perspective-1000">
                            ...
                            <div className="relative z-10 w-72 h-72 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px] transition-transform duration-500 hover:scale-105">
                                ...
                                <div className="absolute top-10 -left-4 md:top-16 md:-left-10 z-20 backdrop-blur-md card p-3 pr-5 rounded-2xl shadow-xl flex items-center gap-3 animate-[bounce_3s_infinite]">
                                    <div className="w-10 h-10 bg-orange-500/20 rounded-full flex items-center justify-center text-orange-500">
                                        <i className="fas fa-fire"></i>
                                    </div>
                                    <div>
                                        <p className="text-xs opacity-70 uppercase tracking-wider font-semibold">Calories</p>
                                        <p className="text-sm font-bold">320 Kcal</p>
                                    </div>
                                </div>

                                <div className="absolute bottom-10 -right-4 md:bottom-16 md:-right-8 z-20 backdrop-blur-md card p-3 pr-5 rounded-2xl shadow-xl flex items-center gap-3 animate-[bounce_3s_infinite] delay-700">
                                    <div className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center text-primary">
                                        <i className="fas fa-drumstick-bite"></i>
                                    </div>
                                    <div>
                                        <p className="text-xs opacity-70 uppercase tracking-wider font-semibold">Protein</p>
                ...
                <section id="features" className="py-16 sm:py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Catat makanan, minuman, dan aktivitas dengan mudah. Database lengkap dengan ribuan makanan lokal dan internasional.</p>

                                <ul className="space-y-2 text-sm opacity-70 mt-auto">
                            ...
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Pahami tren nutrisi dan capai tujuan dengan visualisasi data yang komprehensif dan mudah dipahami.</p>
                            ...
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Dapatkan insight dan rekomendasi yang disesuaikan dengan kebutuhan, preferensi, dan tujuan kesehatan pribadi Anda.</p>
                            ...
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Temukan ribuan resep sehat dengan nutrisi yang sudah dihitung. Filter berdasarkan kalori, waktu masak, dan preferensi diet.</p>
                            ...
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Tetap on-track dengan pengingat cerdas untuk makan, minum air, dan olahraga yang disesuaikan dengan rutinitas harian Anda.</p>
                            ...
                            <div className="feature-card card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                                ...
                                <p className="opacity-80 mb-4">Integrasikan dengan wearables dan aplikasi kesehatan favorit Anda untuk tracking yang lebih akurat dan komprehensif.</p>
                ...
                <section id="how" className="py-16 sm:py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 flex flex-col h-full">
                                ...
                                <div className="card rounded-lg p-4 bg-gradient-to-br from-primary/5 to-transparent mt-auto">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="opacity-70">Daily Calories</span>
                            ...
                            <div className="card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 flex flex-col h-full">
                                ...
                                <div className="card rounded-lg p-4 bg-gradient-to-br from-secondary/5 to-transparent mt-auto">
                                    <div className="space-y-3">
                            ...
                            <div className="card p-8 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300 flex flex-col h-full">
                                ...
                                <div className="card rounded-lg p-4 bg-gradient-to-br from-accent/5 to-transparent mt-auto">
                                    <div className="text-center mb-3">
                                        ...
                                        <div className="text-sm opacity-70">Progress Milestone</div>
                                    </div>
                                    <div className="flex justify-around text-center text-sm">
                                        ...
                                        <div>
                                            ...
                                            <div className="opacity-70 text-xs">Consistency</div>
                                        </div>
                                        <div>
                                            <div className="font-semibold text-accent">28</div>
                                            <div className="opacity-70 text-xs">Days</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-16 sm:py-24">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="space-y-4">
                            <div className="card p-6 rounded-xl shadow-sm hover:border-[#0F9E99] transition-all duration-300">
