            ...
            <section className="relative w-full min-h-screen flex items-center overflow-hidden px-[5%] py-20">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-lg opacity-60 dark:opacity-70 mb-8 leading-relaxed max-w-md">
                    ...
                    <div className="relative h-[500px] flex items-center justify-center">
                        ...
                        <div className="relative z-20 backdrop-blur-xl bg-[#ffffff] dark:bg-[#2a2a2a] border border-[#cccccc] dark:border-[#404040] p-8 rounded-3xl shadow-2xl max-w-md">
                        ...
                        <div className="absolute top-10 right-10 z-10 bg-[#ffffff] dark:bg-[#2a2a2a] border border-[#cccccc] dark:border-[#404040] p-4 rounded-2xl shadow-xl w-64 transform rotate-6 opacity-60 hover:opacity-100 transition duration-300">
                        ...
                        <div className="absolute bottom-10 left-0 z-10 bg-[#ffffff] dark:bg-[#2a2a2a] border border-[#cccccc] dark:border-[#404040] p-4 rounded-2xl shadow-xl w-64 transform -rotate-6 opacity-60 hover:opacity-100 transition duration-300">
                            <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="opacity-60 dark:opacity-70 text-xs">"UI-nya sangat bersih dan modern!"</p>
                        </div>
                ...
                <section id="list" className="py-16 sm:py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="p-8 rounded-md bg-[#ffffff] dark:bg-[#2a2a2a] border border-[#cccccc] dark:border-[#404040] transition-all duration-300 hover:border-primary dark:hover:border-primary hover:shadow-[0_0_20px_rgba(61,204,199,0.15)] flex flex-col">
